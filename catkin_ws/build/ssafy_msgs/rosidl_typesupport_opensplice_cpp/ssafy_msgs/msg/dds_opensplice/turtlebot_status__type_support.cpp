...
#include "ssafy_msgs/msg/turtlebot_status__rosidl_typesupport_opensplice_cpp.hpp"
...
using __dds_msg_type_TurtlebotStatus = ssafy_msgs::msg::dds_::TurtlebotStatus_;
using __ros_msg_type_TurtlebotStatus = ssafy_msgs::msg::TurtlebotStatus;

static ssafy_msgs::msg::dds_::TurtlebotStatus_TypeSupport __type_support_TurtlebotStatus;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_ssafy_msgs
const char *
register_type__TurtlebotStatus(
  ...
  const char * type_name)
{
  ...
  DDS::ReturnCode_t status = __type_support_TurtlebotStatus.register_type(participant, type_name);
  switch (status) {
...
convert_ros_message_to_dds(
  const __ros_msg_type_TurtlebotStatus & ros_message,
  __dds_msg_type_TurtlebotStatus & dds_message)
{
  // member.name twist
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_ssafy_msgs
const char *
publish__TurtlebotStatus(
  void * untyped_topic_writer,
  const void * untyped_ros_message)
{
  DDS::DataWriter * topic_writer = static_cast<DDS::DataWriter *>(untyped_topic_writer);

  const __ros_msg_type_TurtlebotStatus & ros_message = *static_cast<const __ros_msg_type_TurtlebotStatus *>(untyped_ros_message);
  __dds_msg_type_TurtlebotStatus dds_message;
...
convert_dds_message_to_ros(
  const __dds_msg_type_TurtlebotStatus & dds_message,
  __ros_msg_type_TurtlebotStatus & ros_message)
{
  // member.name twist
  ...
  ros_message.can_use_hand =
    (dds_message.can_use_hand_ != 0);
  // member.name can_put
  ros_message.can_put =
    (dds_message.can_put_ != 0);
  // member.name can_lift
  ros_message.can_lift =
    (dds_message.can_lift_ != 0);
}

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_ssafy_msgs
const char *
take__TurtlebotStatus(
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    __ros_msg_type_TurtlebotStatus & ros_message = *static_cast<__ros_msg_type_TurtlebotStatus *>(untyped_ros_message);
  ...
  void * untyped_serialized_data)
{
  ...
  DDS::OpenSplice::CdrTypeSupport cdr_ts(__type_support_TurtlebotStatus);
...
static message_type_support_callbacks_t TurtlebotStatus_callbacks = {
  "ssafy_msgs::msg",
  "TurtlebotStatus",
  &register_type__TurtlebotStatus,
  &publish__TurtlebotStatus,
...
static rosidl_message_type_support_t TurtlebotStatus_handle = {
  rosidl_typesupport_opensplice_cpp::typesupport_identifier,
  &TurtlebotStatus_callbacks,
...
{
  return &ssafy_msgs::msg::typesupport_opensplice_cpp::TurtlebotStatus_handle;
}
