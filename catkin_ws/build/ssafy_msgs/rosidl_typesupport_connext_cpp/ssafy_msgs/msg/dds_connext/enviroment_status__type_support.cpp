...
#include "ssafy_msgs/msg/enviroment_status__rosidl_typesupport_connext_cpp.hpp"
...
DDS_TypeCode *
get_type_code__EnviromentStatus()
{
  ...
  ssafy_msgs::msg::dds_::EnviromentStatus_ & dds_message)
{
  ...
  // member.name weather
  DDS_String_free(dds_message.weather_);
  dds_message.weather_ =
    DDS_String_dup(ros_message.weather.c_str());
...
bool
to_cdr_stream__EnviromentStatus(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const ssafy_msgs::msg::EnviromentStatus & ros_message =
    *(const ssafy_msgs::msg::EnviromentStatus *)untyped_ros_message;

  // create a respective connext dds type
  ssafy_msgs::msg::dds_::EnviromentStatus_ * dds_message = ssafy_msgs::msg::dds_::EnviromentStatus_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  ssafy_msgs::msg::EnviromentStatus & ros_message =
    *(ssafy_msgs::msg::EnviromentStatus *)untyped_ros_message;
...
{
  return &ssafy_msgs::msg::typesupport_connext_cpp::_EnviromentStatus__handle;
}
