...
#include "ssafy_msgs/msg/hand_control__rosidl_typesupport_connext_c.h"
...
#include "ssafy_msgs/msg/dds_connext/HandControl_Support.h"
#include "ssafy_msgs/msg/dds_connext/HandControl_Plugin.h"
...
static DDS_TypeCode *
_HandControl__get_type_code()
{
  return ssafy_msgs::msg::dds_::HandControl_TypeSupport::get_typecode();
}

static bool
_HandControl__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const ssafy_msgs__msg__HandControl * ros_message =
    static_cast<const ssafy_msgs__msg__HandControl *>(untyped_ros_message);
  ssafy_msgs::msg::dds_::HandControl_ * dds_message =
    static_cast<ssafy_msgs::msg::dds_::HandControl_ *>(untyped_dds_message);
...
static bool
_HandControl__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const ssafy_msgs::msg::dds_::HandControl_ * dds_message =
    static_cast<const ssafy_msgs::msg::dds_::HandControl_ *>(untyped_dds_message);
  ssafy_msgs__msg__HandControl * ros_message =
    static_cast<ssafy_msgs__msg__HandControl *>(untyped_ros_message);
  // Member name: control_mode
  {
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const ssafy_msgs__msg__HandControl * ros_message =
    static_cast<const ssafy_msgs__msg__HandControl *>(untyped_ros_message);
  ssafy_msgs::msg::dds_::HandControl_ dds_message;
  if (!_HandControl__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _HandControl__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _HandControl__callbacks = {
  ...
  _HandControl__get_type_code,  // get_type_code
  _HandControl__convert_ros_to_dds,  // convert_ros_to_dds
  _HandControl__convert_dds_to_ros,  // convert_dds_to_ros
  _HandControl__to_cdr_stream,  // to_cdr_stream
  _HandControl__to_message  // to_message
};
