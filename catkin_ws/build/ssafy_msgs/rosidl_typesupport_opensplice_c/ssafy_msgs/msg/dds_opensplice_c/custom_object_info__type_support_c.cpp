...
#include "ssafy_msgs/msg/custom_object_info__rosidl_typesupport_opensplice_c.h"
...
#include "ssafy_msgs/msg/custom_object_info.h"
...
#include "geometry_msgs/msg/vector3.h"  // position

// forward declare type support functions
ROSIDL_TYPESUPPORT_OPENSPLICE_C_IMPORT_ssafy_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  rosidl_typesupport_opensplice_c, geometry_msgs, msg, Vector3)();

using __dds_msg_type_ssafy_msgs__msg__CustomObjectInfo = ssafy_msgs::msg::dds_::CustomObjectInfo_;
using __ros_msg_type_ssafy_msgs__msg__CustomObjectInfo = ssafy_msgs__msg__CustomObjectInfo;

static ssafy_msgs::msg::dds_::CustomObjectInfo_TypeSupport _type_support_ssafy_msgs__msg__CustomObjectInfo;

static const char *
register_type_ssafy_msgs__msg__CustomObjectInfo(void * untyped_participant, const char * type_name)
{
  ...
  DDS::ReturnCode_t status = _type_support_ssafy_msgs__msg__CustomObjectInfo.register_type(participant, type_name);
  switch (status) {
...
static const char *
convert_ros_to_dds_ssafy_msgs__msg__CustomObjectInfo(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const __ros_msg_type_ssafy_msgs__msg__CustomObjectInfo * ros_message = static_cast<const __ros_msg_type_ssafy_msgs__msg__CustomObjectInfo *>(untyped_ros_message);
  __dds_msg_type_ssafy_msgs__msg__CustomObjectInfo * dds_message = static_cast<__dds_msg_type_ssafy_msgs__msg__CustomObjectInfo *>(untyped_dds_message);
  // Field name: position
  {
    ...
    for (DDS::ULong i = 0; i < size; ++i) {
      ...
      const char * err_msg = geometry_msgs__msg__Vector3__callbacks->convert_ros_to_dds(
...
static const char *
publish_ssafy_msgs__msg__CustomObjectInfo(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
  ...
  __dds_msg_type_ssafy_msgs__msg__CustomObjectInfo dds_message;
  const char * err_msg = convert_ros_to_dds_ssafy_msgs__msg__CustomObjectInfo(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_ssafy_msgs__msg__CustomObjectInfo(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __dds_msg_type_ssafy_msgs__msg__CustomObjectInfo * dds_message = static_cast<const __dds_msg_type_ssafy_msgs__msg__CustomObjectInfo *>(untyped_dds_message);
  __ros_msg_type_ssafy_msgs__msg__CustomObjectInfo * ros_message = static_cast<__ros_msg_type_ssafy_msgs__msg__CustomObjectInfo *>(untyped_ros_message);
  // Field name: position
  {
    ...
    for (DDS::ULong i = 0; i < size; i++) {
      ...
      const rosidl_message_type_support_t * ts =
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, geometry_msgs, msg, Vector3)();
...
static const char *
take_ssafy_msgs__msg__CustomObjectInfo(
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_ssafy_msgs__msg__CustomObjectInfo(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_ssafy_msgs__msg__CustomObjectInfo(
  ...
  void * untyped_serialized_data)
{
  ...
  __dds_msg_type_ssafy_msgs__msg__CustomObjectInfo dds_message;
  const char * err_msg = convert_ros_to_dds_ssafy_msgs__msg__CustomObjectInfo(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_ssafy_msgs__msg__CustomObjectInfo);
...
static const char *
deserialize_ssafy_msgs__msg__CustomObjectInfo(
  ...
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_ssafy_msgs__msg__CustomObjectInfo(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t CustomObjectInfo__callbacks = {
  "ssafy_msgs::msg",  // message_namespace
  "CustomObjectInfo",  // message_name
  register_type_ssafy_msgs__msg__CustomObjectInfo,  // register_type
  publish_ssafy_msgs__msg__CustomObjectInfo,  // publish
  take_ssafy_msgs__msg__CustomObjectInfo,  // take
  serialize_ssafy_msgs__msg__CustomObjectInfo,  // serialize message
  deserialize_ssafy_msgs__msg__CustomObjectInfo,  // deserialize message
  convert_ros_to_dds_ssafy_msgs__msg__CustomObjectInfo,  // convert_ros_to_dds
  convert_dds_to_ros_ssafy_msgs__msg__CustomObjectInfo,  // convert_dds_to_ros
};

static rosidl_message_type_support_t CustomObjectInfo__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &CustomObjectInfo__callbacks,  // data
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  CustomObjectInfo)()
{
  return &CustomObjectInfo__type_support;
}
