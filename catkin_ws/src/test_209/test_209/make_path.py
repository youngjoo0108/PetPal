...
class makePath(Node):
    ...
    def __init__(self):
        ...
        self.f = open('C:\\Users\\SSAFY\\Desktop\\\S10P22A209\\catkin_ws\\src\\test_209\\path\\destination.txt','w')
    ...
    def listener_callback(self,msg):
        ...
        if self.is_odom ==False :
            ...
            self.is_odom = True
            self.prev_x = self.msg.pose.pose.position.x
            self.prev_y = self.msg.pose.pose.position.y
