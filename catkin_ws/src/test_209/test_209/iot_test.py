...
class iot_udp(Node):
    ...
    def data_parsing(self,raw_data) :
        ...
        if header == '#Appliances-Status$' and data_length[0] == 20:
            ...
            network_status=params_status[struct.unpack('2B',raw_data[35+16:35+18])]
            device_status=params_status[struct.unpack('2B',raw_data[35+18:35+20])]
