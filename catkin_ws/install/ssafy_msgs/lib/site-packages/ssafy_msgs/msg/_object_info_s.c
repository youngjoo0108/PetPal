...
bool ssafy_msgs__msg__object_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "ssafy_msgs.msg._object_info.ObjectInfo",
        full_classname_dest, 38) == 0);
  }
  ssafy_msgs__msg__ObjectInfo * ros_message = _ros_message;
  {  // num_obj
    ...
    ros_message->num_obj = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // idx_obj
    PyObject * field = PyObject_GetAttrString(_pymsg, "idx_obj");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'idx_obj'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    int16_t * dest = ros_message->idx_obj.data;
...
PyObject * ssafy_msgs__msg__object_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ssafy_msgs.msg._object_info");
  ...
  {  // num_obj
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->num_obj);
    {
  ...
  {  // idx_obj
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "idx_obj");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->idx_obj.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int16_t * src = &(ros_message->idx_obj.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->idx_obj.size * sizeof(int16_t));
      assert(data != NULL);
