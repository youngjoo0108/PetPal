...
bool ssafy_msgs__msg__custom_object_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "ssafy_msgs.msg._custom_object_info.CustomObjectInfo",
        full_classname_dest, 51) == 0);
  }
  ssafy_msgs__msg__CustomObjectInfo * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of CustomObjectInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ssafy_msgs.msg._custom_object_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CustomObjectInfo");
